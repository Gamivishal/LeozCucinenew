import{r as h,j as i,m as e,R as y}from"./index-dDPFfuEa.js";import{H as v,F as f}from"./Footer-DSc2hZrP.js";import{i as x}from"./images-C2bKLPsF.js";import{P as b,C as g}from"./ParallaxImage-Cg4i3Wao.js";import{u as k}from"./useDocumentMeta-B8hrkKo0.js";import{F as w,S as j}from"./shield-check-DtkpEa59.js";import{C}from"./compass-CcZnAB_u.js";import{C as N}from"./clock-Br-8nE0F.js";import{W as I,u as B,a as R}from"./wrench-wXrSw_G6.js";const r=[.16,1,.3,1],u={hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.08,delayChildren:.05}}},S={hidden:{opacity:0,y:30},visible:{opacity:1,y:0,transition:{duration:.8,ease:r}}},o=u,a=S,A={hidden:{opacity:0,scale:1.03,x:70,clipPath:"inset(0% 0% 100% 0%)"},visible:{opacity:1,scale:1,x:0,clipPath:"inset(0% 0% 0% 0%)",transition:{duration:.9,ease:r,delay:.1}}},l={hidden:{opacity:0,x:-60},visible:{opacity:1,x:0,transition:{duration:.6,ease:r}}},F={hidden:{opacity:0,x:-60},visible:{opacity:1,x:0,transition:{duration:.7,ease:r}}},E={hidden:{opacity:0,x:60},visible:{opacity:1,x:0,transition:{duration:.7,ease:r}}},T=()=>{const d=y.useRef(null),{scrollYProgress:p}=B({target:d,offset:["start center","end center"]}),m=R(p,[0,1],["0%","100%"]),t=[{step:"01",title:"Site Visit & Measurement",desc:"We visit your space and take precise measurements."},{step:"02",title:"Custom Layout & 3D Design",desc:"A layout and 3D design tailored to your space."},{step:"03",title:"Material & Finish Selection",desc:"Choose the materials and finishes that suit you."},{step:"04",title:"In-House Manufacturing",desc:"Your kitchen is built at our own factory."},{step:"05",title:"Professional Installation",desc:"Installed by our own in-house team."},{step:"06",title:"Post-Installation Quality Check",desc:"A final check to ensure everything is right."}];return i.jsxs("section",{"aria-label":"Our Process",style:{paddingTop:"var(--space-section-padding-desktop)",paddingBottom:"var(--space-section-padding-desktop)",paddingLeft:"6vw",paddingRight:"6vw",backgroundColor:"var(--color-surface-dark)",color:"var(--color-text-primary)"},children:[i.jsxs("div",{style:{maxWidth:"900px",margin:"0 auto"},children:[i.jsxs("div",{style:{textAlign:"center",marginBottom:"clamp(50px, 7vw, 90px)"},children:[i.jsx("span",{className:"section-label",style:{display:"block",marginBottom:"16px"},children:"OUR PROCESS"}),i.jsxs(e.h2,{className:"section-title text-white",initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.3},variants:o,children:[i.jsx(e.span,{variants:a,style:{display:"inline-block",marginRight:"0.25em"},children:"From Consultation"}),i.jsx(e.span,{variants:a,style:{display:"inline-block"},children:"to Installation."})]})]}),i.jsxs("div",{ref:d,className:"mk-timeline",children:[i.jsx("div",{className:"mk-timeline-track","aria-hidden":"true"}),i.jsx(e.div,{className:"mk-timeline-progress",style:{height:m},"aria-hidden":"true"}),t.map((n,s)=>{const c=s%2===0;return i.jsxs("div",{className:`mk-timeline-row ${c?"is-left":"is-right"}`,children:[i.jsxs(e.div,{className:"mk-timeline-content",initial:{opacity:0,x:c?-36:36},whileInView:{opacity:1,x:0},viewport:{once:!0,amount:.5},transition:{duration:.7,ease:r},children:[i.jsx("span",{style:{fontFamily:"var(--font-family-sans)",fontSize:"13px",fontWeight:600,color:"var(--color-accent)",display:"block",marginBottom:"8px"},children:n.step}),i.jsx("h3",{className:"sub-title text-white",style:{marginBottom:"8px"},children:n.title}),i.jsx("p",{className:"small-description",style:{color:"var(--color-text-secondary)"},children:n.desc})]}),i.jsx(e.span,{className:"mk-timeline-dot",initial:{backgroundColor:"var(--color-surface-dark)",scale:.7},whileInView:{backgroundColor:"#B69A6B",scale:1},viewport:{once:!0,amount:.5},transition:{duration:.4,ease:r},"aria-hidden":"true"})]},n.step)})]})]}),i.jsx("style",{children:`
        .mk-timeline {
          position: relative;
          padding: 12px 0;
        }
