import{h as F,i as T,r as u,p as R,a as z,j as e,m as a,R as y}from"./index-B1CwW_lB.js";import{c as k,L,H as O,F as V}from"./Footer-bVcuaOZl.js";import{i as v}from"./images-C2bKLPsF.js";import{u as A}from"./useDocumentMeta-B-e47bu4.js";import{C as P}from"./compass-DE27ikUk.js";import{F as C,S as I}from"./shield-check-2W-M8pfI.js";import{C as D}from"./clock-8Tn85k8F.js";import{W as M,u as G,a as K}from"./wrench-CZRRHJ0e.js";import{A as Y}from"./award-Ds5cimNS.js";import{G as U,H as Z}from"./handshake-DPJ1M8LP.js";function X(){!F.current&&T();const[t]=u.useState(R.current);return t}const $={some:0,all:1};function q(t,i,{root:o,margin:r,amount:s="some"}={}){const n=z(t),l=new WeakMap,h=m=>{m.forEach(d=>{const x=l.get(d.target);if(d.isIntersecting!==!!x)if(d.isIntersecting){const f=i(d);typeof f=="function"?l.set(d.target,f):p.unobserve(d.target)}else typeof x=="function"&&(x(d),l.delete(d.target))})},p=new IntersectionObserver(h,{root:o,rootMargin:r,threshold:typeof s=="number"?s:$[s]});return n.forEach(m=>p.observe(m)),()=>p.disconnect()}function _(t,{root:i,margin:o,amount:r,once:s=!1}={}){const[n,l]=u.useState(!1);return u.useEffect(()=>{if(!t.current||s&&n)return;const h=()=>(l(!0),s?void 0:()=>l(!1)),p={root:i&&i.current||void 0,margin:o,amount:r};return q(t.current,h,p)},[i,t,o,s,r]),n}/**
 ...
 */const Q=k("Shirt",[["path",{d:"M20.38 3.46 16 2a4 4 0 0 1-8 0L3.62 3.46a2 2 0 0 0-1.34 2.23l.58 3.47a1 1 0 0 0 .99.84H6v10c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V10h2.15a1 1 0 0 0 .99-.84l.58-3.47a2 2 0 0 0-1.34-2.23z",key:"1wgbhj"}]]),S="leoz_preloader_seen",j=()=>{if(typeof window>"u"||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return!1;try{return sessionStorage.getItem(S)!=="true"}catch{return!1}},ee=()=>{try{sessionStorage.setItem(S,"true")}catch{}},te=({isActive:t,isExiting:i})=>t?e.jsx(a.div,{"aria-hidden":"true",initial:{y:"0%"},animate:{y:i?"-100%":"0%"},transition:{duration:1.1,ease:[.76,0,.24,1]},style:{position:"fixed",inset:0,zIndex:9999,backgroundColor:"var(--color-surface-dark)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",willChange:"transform"},children:e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"18px",opacity:i?0:1,transform:i?"translateY(-8px)":"translateY(0)",transition:"opacity 400ms cubic-bezier(0.16, 1, 0.3, 1), transform 400ms cubic-bezier(0.16, 1, 0.3, 1)"},children:[e.jsx(L,{}),e.jsx("span",{style:{fontFamily:"var(--font-family-sans)",fontSize:"11px",fontWeight:600,letterSpacing:"0.3em",textTransform:"uppercase",color:"#B69A6B"},children:"Kitchens & Wardrobes"})]})}):null,ie=[.16,1,.3,1],N={hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.08,delayChildren:.05}}},g={hidden:{opacity:0,y:20},visible:{opacity:1,y:0,transition:{duration:.5,ease:ie}}},c=[.16,1,.3,1],ae=()=>{const t={hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.15,delayChildren:.1}}},i={hidden:{opacity:0,y:30},visible:{opacity:1,y:0,transition:{duration:1,ease:c}}};return e.jsxs("section",{id:"hero","aria-label":"Leoz Cucine Hero",style:{position:"relative",height:"100vh",width:"100%",overflow:"hidden",display:"flex",alignItems:"center",justifyContent:"center"},children:[e.jsx("img",{src:v.hero,alt:"Leoz Cucine premium kitchen",style:{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover"}}),e.jsx("div",{style:{position:"absolute",inset:0,background:"linear-gradient(180deg, rgba(10, 10, 10, 0.55) 0%, rgba(10, 10, 10, 0.4) 50%, rgba(10, 10, 10, 0.6) 100%)"}}),e.jsx("div",{style:{position:"absolute",inset:0,background:"radial-gradient(ellipse 60% 55% at 50% 48%, rgba(0, 0, 0, 0.35) 0%, rgba(0, 0, 0, 0) 100%)"}}),e.jsx("div",{"aria-hidden":"true",style:{position:"absolute",left:0,right:0,bottom:0,height:"14vh",background:"linear-gradient(180deg, transparent 0%, var(--color-surface-light) 100%)",pointerEvents:"none"}}),e.jsxs(a.div,{variants:t,initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.15},style:{position:"relative",zIndex:2,textAlign:"center",padding:"0 24px",maxWidth:"900px",display:"flex",flexDirection:"column",alignItems:"center"},children:[e.jsx(a.span,{variants:i,className:"section-label text-white",style:{display:"block",marginBottom:"22px",textShadow:"0 2px 16px rgba(0, 0, 0, 0.5)"},children:"KITCHENS & WARDROBES"}),e.jsxs("h1",{className:"hero-title text-white",style:{marginBottom:"22px",textShadow:"0 4px 30px rgba(0, 0, 0, 0.45)"},children:[e.jsx(a.span,{variants:i,style:{display:"inline-block",marginRight:"0.25em"},children:"German-Engineered"}),e.jsx(a.span,{variants:i,style:{display:"inline-block",marginRight:"0.25em"},children:"Kitchens & Wardrobes,"}),e.jsx(a.span,{variants:i,style:{display:"inline-block"},children:"Crafted in Gujarat"})]}),e.jsx(a.p,{variants:i,className:"hero-description text-light",style:{margin:"0 auto 36px",maxWidth:"620px",textShadow:"0 2px 16px rgba(0, 0, 0, 0.5)"},children:"LEOZ Cucine brings 20+ years of manufacturing expertise and German design precision to homes across Ahmedabad and throughout Gujarat — designed, built, and installed entirely in-house."}),e.jsxs("div",{className:"hero-cta-container",style:{display:"flex",gap:"16px",justifyContent:"center",flexWrap:"wrap"},children:[e.jsx(a.a,{variants:i,href:"/talk-to-us",onClick:o=>{o.preventDefault(),window.history.pushState({},"","/talk-to-us"),window.dispatchEvent(new Event("popstate"))},className:"btn btn-light home-cta-btn",children:"Book a Free Consultation"}),e.jsx(a.a,{variants:i,href:"#collections",onClick:o=>{var r;o.preventDefault(),(r=document.getElementById("collections"))==null||r.scrollIntoView({behavior:"smooth"})},className:"btn btn-outline home-cta-btn home-cta-btn-outline",style:{borderColor:"#FFFFFF",color:"#FFFFFF"},children:"Explore Our Collections"})]})]}),e.jsx("style",{children:`
      ...
      `})]})},le=()=>{const t=[{icon:J,title:"German Style Modular Kitchens",description:"Experience the perfect blend of sleek design, functionality, and customization. Our modular kitchens are crafted with precision, offering innovative storage solutions and contemporary aesthetics suited to modern lifestyles."},{icon:Q,title:"Customized Wardrobes",description:"Maximize your space with our innovative wardrobe designs. Tailored to your needs, our wardrobes combine practicality with elegance, ensuring optimal storage and a clutter-free environment."}];return e.jsx("section",{"aria-label":"Product Highlights",style:{paddingTop:"var(--space-section-padding-desktop)",paddingBottom:"var(--space-section-padding-desktop)",paddingLeft:"6vw",paddingRight:"6vw",backgroundColor:"var(--color-light)",color:"var(--color-heading)"},children:e.jsxs("div",{style:{maxWidth:"1200px",margin:"0 auto"},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:"clamp(50px, 7vw, 90px)"},children:[e.jsx("span",{className:"section-label section-label-on-light",style:{display:"block",marginBottom:"16px"},children:"PRODUCT HIGHLIGHTS"}),e.jsx(a.h2,{className:"section-title",initial:{opacity:0,x:-50},whileInView:{opacity:1,x:0},viewport:{once:!0,amount:.3},transition:{duration:.8,ease:[.16,1,.3,1]},children:"Premium Solutions for Kitchens & Wardrobes"})]}),e.jsx("div",{className:"home-highlights-grid",style:{display:"grid",gridTemplateColumns:"repeat(2, 1fr)",gap:"clamp(28px, 3vw, 48px)"},children:t.map((i,o)=>{const r=i.icon;return e.jsx(a.div,{className:"home-highlight-card",initial:{opacity:0,x:o%2===0?-100:100},whileInView:{opacity:1,x:0},viewport:{once:!0,amount:.2},transition:{duration:.8,ease:c},style:{position:"relative"},children:e.jsxs(a.div,{whileHover:{y:-8,boxShadow:"0 24px 48px rgba(182,154,107,0.15)",borderColor:"rgba(182,154,107,0.6)"},transition:{duration:.4,ease:"easeOut"},style:{position:"relative",display:"flex",flexDirection:"column",gap:"18px",padding:"clamp(32px, 3.5vw, 44px)",backgroundColor:"var(--color-surface-stone)",border:"1px solid var(--color-border-gold)",borderRadius:"var(--radius-md)",boxShadow:"var(--shadow-subtle)",overflow:"hidden"},children:[e.jsx("span",{className:"home-highlight-card-bar","aria-hidden":"true"}),e.jsx("div",{style:{width:"56px",height:"56px",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",backgroundColor:"rgba(182, 154, 107, 0.12)",color:"#B69A6B"},children:e.jsx(r,{size:26,strokeWidth:1.5})}),e.jsx("h3",{className:"sub-title",style:{margin:0},children:i.title}),e.jsx("p",{className:"description",style:{margin:0},children:i.description})]})},i.title)})})]})})},ce=()=>{const t=y.useRef(null),{scrollYProgress:i}=G({target:t,offset:["start center","end center"]}),o=K(i,[0,1],["0%","100%"]),r=[{title:"Consultation",desc:"We understand your kitchen or wardrobe space, needs, and style."},{title:"Design",desc:"Our team creates a kitchen or wardrobe layout tailored to your requirements."},{title:"Manufacturing",desc:"Your kitchen or wardrobe is built at our own 20,000 sq. ft. facility."},{title:"Installation",desc:"Our in-house team installs and finishes the project."},{title:"After-Sales Support",desc:"Warranty-backed service, long after installation."}];return e.jsxs("section",{"aria-label":"Our Process",style:{paddingTop:"var(--space-section-padding-desktop)",paddingBottom:"var(--space-section-padding-desktop)",paddingLeft:"6vw",paddingRight:"6vw",backgroundColor:"var(--color-light)",color:"var(--color-heading)"},children:[e.jsxs("div",{style:{maxWidth:"900px",margin:"0 auto"},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:"clamp(50px, 7vw, 90px)"},children:[e.jsx("span",{className:"section-label section-label-on-light",style:{display:"block",marginBottom:"16px"},children:"HOW WE WORK"}),e.jsx(a.h2,{className:"section-title",initial:{opacity:0,x:50},whileInView:{opacity:1,x:0},viewport:{once:!0,amount:.3},transition:{duration:.8,ease:c},children:"From Idea to Installation."})]}),e.jsxs("div",{ref:t,className:"home-timeline",children:[e.jsx("div",{className:"home-timeline-track","aria-hidden":"true"}),e.jsx(a.div,{className:"home-timeline-progress",style:{height:o},"aria-hidden":"true"}),r.map((s,n)=>{const l=n%2===0;return e.jsxs("div",{className:`home-timeline-row ${l?"is-left":"is-right"}`,children:[e.jsxs(a.div,{className:"home-timeline-content",initial:{opacity:0,x:l?-36:36},whileInView:{opacity:1,x:0},viewport:{once:!0,amount:.5},transition:{duration:.7,ease:c},children:[e.jsx("h3",{className:"sub-title",style:{marginBottom:"8px"},children:s.title}),e.jsx("p",{className:"small-description",children:s.desc})]}),e.jsx(a.span,{className:"home-timeline-dot",initial:{backgroundColor:"#F7F5F1",scale:.7},whileInView:{backgroundColor:"#B69A6B",scale:1},viewport:{once:!0,amount:.5},transition:{duration:.4,ease:c},"aria-hidden":"true"})]},s.title)})]})]}),e.jsx("style",{children:`
        .home-timeline {
          position: relative;
          padding: 12px 0;
        }
      ...
      `})]})},de=()=>{const t=[{icon:P,title:"German Design Influence",description:"Precision, engineering, and clean form language adapted for Indian homes and climate."},{icon:C,title:"Own Manufacturing Factory",description:"We design and manufacture in-house, giving us complete control over quality, materials, and finish."},{icon:D,title:"20+ Years of Experience",description:"Two decades of refining our craft, materials, and processes."},{icon:I,title:"Comprehensive Warranty",description:"Backed by a warranty that reflects our confidence in what we build."},{icon:M,title:"End-to-End Installation Service",description:"From design consultation to final installation, handled entirely by our own team."}];return e.jsx("section",{"aria-label":"Why Leoz Cucine",style:{paddingTop:"var(--space-section-padding-desktop)",paddingBottom:"var(--space-section-padding-desktop)",paddingLeft:"6vw",paddingRight:"6vw",backgroundColor:"var(--color-surface-dark)",color:"var(--color-text-primary)"},children:e.jsxs("div",{style:{maxWidth:"1300px",margin:"0 auto"},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:"clamp(50px, 7vw, 90px)"},children:[e.jsx("span",{className:"section-label",style:{display:"block",marginBottom:"16px"},children:"WHY CHOOSE LEOZ CUCINE"}),e.jsx(a.h2,{className:"section-title text-white",initial:{opacity:0,x:-50},whileInView:{opacity:1,x:0},viewport:{once:!0,amount:.3},transition:{duration:.8,ease:[.16,1,.3,1]},children:"Built to Be Chosen, Not Just Sold."})]}),e.jsx("div",{className:"home-pillars-grid",style:{display:"grid",gridTemplateColumns:"repeat(5, 1fr)",gap:"clamp(20px, 2.4vw, 28px)"},children:t.map((i,o)=>{const r=i.icon;return e.jsxs(a.div,{className:"home-pillar-card",initial:{opacity:0,x:o%2===0?-100:100},whileInView:{opacity:1,x:0},viewport:{once:!0,amount:.2},transition:{duration:.8,delay:o*.08,ease:c},whileHover:{y:-8,borderColor:"rgba(182, 154, 107, 0.45)",backgroundColor:"#242424",boxShadow:"0 18px 40px -14px rgba(182, 154, 107, 0.3)",transition:{duration:.35,ease:c}},style:{position:"relative",overflow:"hidden",textAlign:"center",display:"flex",flexDirection:"column",alignItems:"center",gap:"10px",padding:"clamp(24px, 2.6vw, 32px) clamp(16px, 2vw, 22px)",backgroundColor:"var(--color-surface-dark-secondary)",border:"1px solid var(--color-border-gold)",borderRadius:"var(--radius-md)"},children:[e.jsx("span",{className:"home-pillar-card-bar","aria-hidden":"true"}),e.jsx("div",{className:"home-pillar-icon",style:{width:"52px",height:"52px",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",backgroundColor:"rgba(182, 154, 107, 0.12)",color:"#B69A6B",marginBottom:"6px",flexShrink:0},children:e.jsx(r,{size:22,strokeWidth:1.5})}),e.jsx("h3",{className:"sub-title text-white",style:{fontSize:"18px",margin:0,minHeight:"48px",display:"flex",alignItems:"flex-start",justifyContent:"center"},children:i.title}),e.jsx("p",{className:"small-description",style:{color:"var(--color-text-secondary)",margin:0},children:i.description})]},i.title)})})]})})},pe=()=>e.jsx("section",{"aria-label":"For Trade Professionals",style:{paddingTop:"var(--space-section-padding-desktop)",paddingBottom:"var(--space-section-padding-desktop)",paddingLeft:"6vw",paddingRight:"6vw",backgroundColor:"var(--color-surface-dark)",color:"var(--color-text-primary)",display:"flex",flexDirection:"column",alignItems:"center"},children:e.jsxs("div",{style:{maxWidth:"760px",width:"100%",textAlign:"center",display:"flex",flexDirection:"column",alignItems:"center"},children:[e.jsx(a.div,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.5},transition:{duration:.8,ease:c},style:{width:"56px",height:"56px",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",backgroundColor:"rgba(182, 154, 107, 0.12)",color:"#B69A6B",marginBottom:"24px"},children:e.jsx(Z,{size:26,strokeWidth:1.5})}),e.jsx(a.span,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.3},transition:{duration:.8,ease:c},className:"section-label",style:{display:"block",marginBottom:"16px"},children:"FOR TRADE PROFESSIONALS"}),e.jsx(a.h2,{initial:{opacity:0,x:100},whileInView:{opacity:1,x:0},viewport:{once:!0,amount:.5},transition:{duration:1,ease:c},className:"section-title text-white",style:{marginBottom:"24px"},children:"Partnering with Architects, Interior Designers & Builders"}),e.jsx("div",{style:{margin:"0 auto",marginBottom:"clamp(28px, 4vw, 44px)"},children:["We work closely with design and construction professionals","across Gujarat, offering dedicated support, technical","specifications, and reliable timelines for client projects."].map((t,i)=>e.jsx(a.div,{initial:{opacity:0,x:-100},whileInView:{opacity:1,x:0},viewport:{once:!0,amount:.3},transition:{duration:.8,ease:c},children:e.jsx("span",{className:"description text-light",style:{display:"block",margin:0},children:t})},i))}),e.jsx(a.div,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.5},transition:{duration:.8,ease:c},children:e.jsx("a",{href:"/contact",onClick:t=>{t.preventDefault(),window.history.pushState({},"","/contact"),window.dispatchEvent(new Event("popstate"))},className:"btn btn-light home-cta-btn",children:"Partner With Us"})})]})}),he=()=>e.jsxs("section",{id:"consultation","aria-label":"Talk To Us",style:{position:"relative",minHeight:"80vh",width:"100%",display:"flex",alignItems:"center",justifyContent:"center",backgroundColor:"var(--color-surface-dark)",color:"var(--color-text-primary)",overflow:"hidden"},children:[e.jsx(a.div,{initial:{opacity:0,scale:1.03},whileInView:{opacity:.45,scale:1},viewport:{once:!0,amount:.15},transition:{duration:1,ease:c},style:{position:"absolute",inset:0,backgroundImage:`url(${v.consultationBg})`,backgroundPosition:"center",backgroundSize:"cover",willChange:"transform, opacity"}}),e.jsx("div",{style:{position:"absolute",inset:0,background:"radial-gradient(circle, rgba(24,24,24,0.3) 0%, rgba(24,24,24,0.9) 100%)"}}),e.jsxs(a.div,{initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.3},variants:{hidden:{},visible:{transition:{staggerChildren:.2}}},style:{position:"relative",zIndex:10,maxWidth:"900px",padding:"80px 6vw",textAlign:"center",display:"flex",flexDirection:"column",alignItems:"center"},children:[e.jsx(a.h2,{initial:{opacity:0,x:100},whileInView:{opacity:1,x:0},viewport:{once:!0,amount:.5},transition:{duration:1,ease:[.16,1,.3,1]},className:"section-title text-white",style:{marginBottom:"24px"},children:"Let's Design Your Kitchen or Wardrobe"}),e.jsx("div",{style:{margin:"0 auto",marginBottom:"clamp(28px, 4vw, 44px)"},children:["Whether you're planning a new kitchen,","upgrading your wardrobe, or specifying","kitchens and wardrobes for a residential project,","our team is ready to help."].map((t,i)=>e.jsx(a.div,{initial:{opacity:0,x:-100},whileInView:{opacity:1,x:0},viewport:{once:!0,amount:.3},transition:{duration:.8,ease:[.16,1,.3,1]},children:e.jsx("span",{className:"description text-light",style:{display:"block",margin:0},children:t})},i))}),e.jsx(a.div,{variants:{hidden:{opacity:0,y:20},visible:{opacity:1,y:0,transition:{duration:.8,ease:[.16,1,.3,1]}}},children:e.jsx("a",{href:"/talk-to-us",onClick:t=>{t.preventDefault(),window.history.pushState({},"","/talk-to-us"),window.dispatchEvent(new Event("popstate"))},className:"btn btn-light home-cta-btn",children:"Talk to Us Today"})})]})]}),Ce=()=>{const[t,i]=u.useState(0),[o,r]=u.useState(j),[s,n]=u.useState(!1),[l,h]=u.useState(()=>!j());return A("Leoz Cucine | German-Engineered Kitchens & Wardrobes in Gujarat","LEOZ Cucine brings 20+ years of manufacturing expertise and German design precision to homes across Ahmedabad and throughout Gujarat."),u.useEffect(()=>{if(!o)return;window.scrollTo(0,0),document.body.style.overflow="hidden";const p=setTimeout(()=>{n(!0),h(!0)},400),m=setTimeout(()=>{r(!1),document.body.style.overflow="",ee()},1500);return()=>{clearTimeout(p),clearTimeout(m),document.body.style.overflow=""}},[o]),u.useEffect(()=>{const p=()=>{const m=window.scrollY,d=document.documentElement.scrollHeight-window.innerHeight;d>0&&i(m/d*100)};return window.addEventListener("scroll",p,{passive:!0}),()=>window.removeEventListener("scroll",p)},[]),e.jsxs("div",{className:"page-home",children:[e.jsx(te,{isActive:o,isExiting:s}),e.jsx("div",{className:"scroll-progress-bar",style:{transform:`scaleX(${t/100})`}}),e.jsx(O,{isPreloaderActive:o,showHeader:l}),e.jsxs("main",{id:"main-content",children:[e.jsx(ae,{}),e.jsx(oe,{}),e.jsx(se,{}),e.jsx(le,{}),e.jsx(de,{}),e.jsx(re,{}),e.jsx(ce,{}),e.jsx(pe,{}),e.jsx(he,{})]}),e.jsx(V,{}),e.jsx("style",{children:`
